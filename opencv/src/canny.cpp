...
int main(int argc,char *argv[])  
{
	...
	imageSource=imread("/home/jianzhuozhu/catkin_ws_tools/src/img/canny_1.png");  //读入RGB图像
	...
	GaussianBlur(imageGray,imageGaussian,Size(9,9),0,0);
	...
	DoubleThresholdLink(imageLocalMax,40,60);   //双阈值中间阈值滤除及连接
